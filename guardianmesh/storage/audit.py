...
class AuditEventType(str, Enum):
    ...
    # Aegis / Android Companion (Phase 8)
    AEGIS_SESSION_CREATED = "AEGIS_SESSION_CREATED"
    AEGIS_SYSTEM_CONSENT_REQUESTED = "AEGIS_SYSTEM_CONSENT_REQUESTED"
    AEGIS_SYSTEM_CONSENT_GRANTED = "AEGIS_SYSTEM_CONSENT_GRANTED"
    AEGIS_SYSTEM_CONSENT_DENIED = "AEGIS_SYSTEM_CONSENT_DENIED"
    AEGIS_CAPTURE_STARTED = "AEGIS_CAPTURE_STARTED"
    AEGIS_CAPTURE_STOPPED = "AEGIS_CAPTURE_STOPPED"
    AEGIS_SESSION_EXPIRED = "AEGIS_SESSION_EXPIRED"
    AEGIS_PROVIDER_FAILED = "AEGIS_PROVIDER_FAILED"
    AEGIS_ENCODER_FAILED = "AEGIS_ENCODER_FAILED"
    AEGIS_FOREGROUND_SERVICE_STARTED = "AEGIS_FOREGROUND_SERVICE_STARTED"
    AEGIS_FOREGROUND_SERVICE_STOPPED = "AEGIS_FOREGROUND_SERVICE_STOPPED"

    # Orion / Orchestration (Phase 9)
    ORION_EVENT_ACCEPTED = "ORION_EVENT_ACCEPTED"
    ORION_EVENT_REJECTED = "ORION_EVENT_REJECTED"
    ORION_ACTION_CREATED = "ORION_ACTION_CREATED"
    ORION_ACTION_STARTED = "ORION_ACTION_STARTED"
    ORION_ACTION_COMPLETED = "ORION_ACTION_COMPLETED"
    ORION_ACTION_FAILED = "ORION_ACTION_FAILED"
    ORION_ACTION_EXPIRED = "ORION_ACTION_EXPIRED"
    ORION_RECONCILIATION_STARTED = "ORION_RECONCILIATION_STARTED"
    ORION_RECONCILIATION_COMPLETED = "ORION_RECONCILIATION_COMPLETED"
    ORION_CONFLICT_RESOLVED = "ORION_CONFLICT_RESOLVED"
    ORION_CAPABILITY_CHANGED = "ORION_CAPABILITY_CHANGED"
